...
// fileExists se conserva por si se quiere usar desde tests futuros.
func fileExists(path string) bool {
	_, err := os.Stat(path)
	return err == nil || !errorsIs(err, fs.ErrNotExist)
}

// errorsIs aísla la dependencia de errors.Is para usar fs.ErrNotExist
// sin importar errors completo arriba.
